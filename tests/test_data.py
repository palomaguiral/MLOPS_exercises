import sys
sys.path.append("C:/Users/usuario/MLOPS/nuevo_repo/src/models/")
...
import os.path
@pytest.mark.skipif(not os.path.exists("C:/Users/usuario/MLOPS/nuevo_repo/data/processed/test.npz"), reason="Test data files not found")

#Check if train data exists
@pytest.mark.skipif(not os.path.exists("C:/Users/usuario/MLOPS/nuevo_repo/data/data/processed/train_data.npz"), reason="Train data files not found")
...
def test_data():
    ...
    if train ==True: #if we are checking training data
        N_data = 25000 
